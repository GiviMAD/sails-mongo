  ...
  var adapter = {
    ...
    registerConnection: function(connection, collections, cb) {
      ...
      new Connection(connection, function(_err, db) {
        ...
        if(_err) {
          delete connections[connection.identity];
    ...
    teardown: function (conn, cb) {
      ...
      var dbConnection = connections[conn].connection ? connections[conn].connection.db : null;
    ...
    mongo: {
       ...
       * getConnection
       *
       * Return a native Mongo database connection
       *
       * @param {Object} db
       */
      getConnection: function(connectionName){
        var connectionInfo = connections[connectionName];
        if (!connectionInfo) {
          return null;
        }

        var connectionObject = connectionInfo.connection;
        if (!connectionObject) {
          return null;
        }

        var mongoDb = connectionObject.db;
        return mongoDb;
      }
    ...
    create: function(connectionName, collectionName, data, cb, meta) {
    ...
    createEach: function(connectionName, collectionName, data, cb, meta) {
    ...
    find: function(connectionName, collectionName, options, cb, meta) {
      options = options || {};
      var connectionObject = connections[connectionName];
      var collection = connectionObject.collections[collectionName];
    ...
    update: function(connectionName, collectionName, options, values, cb, meta) {
      options = options || {};
      var connectionObject = connections[connectionName];
      var collection = connectionObject.collections[collectionName];
    ...
    destroy: function(connectionName, collectionName, options, cb, meta) {
      options = options || {};
      var connectionObject = connections[connectionName];
      var collection = connectionObject.collections[collectionName];
    ...
    count: function(connectionName, collectionName, options, cb, meta) {
      options = options || {};
      var connectionObject = connections[connectionName];
      var collection = connectionObject.collections[collectionName];
     ...
     */
    join: function (connectionName, collectionName, criteria, cb, meta) {
      ...
      _runJoins({
        ...
        $find: function (collectionIdentity, criteria, cb) {
          ...
          return collection.find(criteria, cb, meta);
        },
     ...
     * @param {Object} stream
     */
    stream: function(connectionName, collectionName, options, stream, meta) {
      options = options || {};
      var connectionObject = connections[connectionName];
      var collection = connectionObject.collections[collectionName];

      collection.stream(options, stream, meta);
    },
